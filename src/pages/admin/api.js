...
export default {
  ...
  // 获取分类列表
  getClassifyList (offset, limit) {
    return ajax('admin/problem/classify_list', 'get', {
      params: {
        paging: true,
        offset,
        limit
  ...
  // 获取子类列表
  getSubclassList () {
    return ajax('admin/problem/subclass', 'get')
  },
  // 点击大类筛选出小类
  getSubclassListSelect (id) {
    return ajax('admin/problem/subclass', 'get', {
      params: {
        id
      }
  ...
  // 删除一级分类
  deleteClassify (id) {
    return ajax('admin/problem/classify_list', 'delete', {
      params: {
        id
      }
    })
  ...
  // 删除二级分类
  deleteSubclass (id) {
    return ajax('admin/problem/subclass', 'delete', {
      params: {
        id
      }
    })
  ...
  // 修改一级分类
  updateClassify (data) {
    return ajax('admin/problem/classify_list', 'put', {
      data
    })
  },
  // 修改二级分类
  updateSubclass (data) {
    return ajax('admin/problem/subclass', 'put', {
      data
    })
  },
  // 添加公告
  ...
  // 添加一级分类
  createClassify (data) {
    return ajax('admin/problem/classify_list', 'post', {
      data
    })
  },
  // 添加二级分类
  createSubclass (data) {
    // console.log('添加二级分类')
    return ajax('admin/problem/subclass', 'post', {
      data
    })
  },
  // 获取用户列表
